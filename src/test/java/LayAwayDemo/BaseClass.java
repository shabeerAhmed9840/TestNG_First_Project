...
public class BaseClass {
	...
	public static void launch(String url) {
		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\SHABEER AHMED\\eclipse-workspace\\Employee\\driver\\chromedriver.exe");
	...
	public static void fileLocation(String s1) {
		loc = new File(s1);
	...
	// to get screenshot
	public static void screenShot(String File, String Name) throws IOException {
		TakesScreenshot shot = (TakesScreenshot) driver;
		File src = shot.getScreenshotAs(OutputType.FILE);
		System.out.println(src);

		FileUtils.copyFile(src, new File(File + Name));
	}

	public static void failedScreenshot(String location,String failed) throws Exception{
		File screenshotAs = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		File loc =new File(location+failed+"_"+".jpg");
